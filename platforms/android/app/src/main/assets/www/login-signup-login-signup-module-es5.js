...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-signup-login-signup-module"], {
  ...
  function srcAppLoginSignupCoverCoverComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CoverComponent = /*#__PURE__*/function () {
      function CoverComponent(men, nav) {
  ...
  function srcAppLoginSignupLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(nav, http, datastream, men) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login(mobile, password) {
          ...
          mobile = "+20" + mobile;
          this.http.Login(mobile, password).subscribe(function (tokenObj) {
            _this.showSplash = true;
            console.log("Token: ", tokenObj.token);

            _this.datastream.setToken(tokenObj.token);

            _this.http.editFCMToken();

            _this.http.getDoctorUsingToken().subscribe(function (doctordata) {
              console.log("http doctor data", doctordata);
              that.datastream.setDoctor(doctordata.mydoctor);

              _this.datastream.clearPatientList();

              doctordata.patientArrayList.forEach(function (element) {
                _this.datastream.addToPatientList(element);
              });
            ...
            return alert('HTTP Login Error: ' + err);
          }, function () {
            return console.log('HTTP Login request completed.');
          });
        }
      }, {
        key: "backClick",
