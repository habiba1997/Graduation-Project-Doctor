...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeChatChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY = 'my_image';

    var ChatComponent = /*#__PURE__*/function () {
      function ChatComponent(intComp, navigation, httpService, dataStream, communication, camera, file, webview, actionSheetController, toastController, storage, plt, ref, filePath, network) {
      ...
      _createClass(ChatComponent, [{
        ...
        value: function ionViewWillEnter() {
          ...
          new Promise(function (resolve, reject) {
            _this6.dId = _this6.dataStream.getDoctorId();

            if (_this6.dId == undefined) {
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return this.communication.msg.subscribe(function (massagesFromMessageOrConvList) {
                        ...
                        _this7.newMessages = massagesFromMessageOrConvList.newMessages;
                        _this7.thread = massagesFromMessageOrConvList.thread;
                        _this7.thread_id = massagesFromMessageOrConvList.thread_id;
                        _this7.showSplash = true;
            ...
            return _this6.showSplash = false;
          });
        }
      }, {
        key: "ionViewDidEnter",
        ...
        value: function ScrollToBottom() {
          ...
          setTimeout(function () {
            _this8.bigContent.scrollToBottom(100);
          }, 1000);
        } ////////////////////
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return this.userToRecieve = this.patientArray.find(function (patient) {
                      return patient.patientId == _this9.newMsgs.receiver_id || patient.patientId == _this9.newMsgs.sender_id;
                    });
        ...
        value: function sendReply(threadId) {
          ...
          this.httpService.postReply(this.data, threadId).subscribe(function (res) {
            ...
            _this10.newMessages.push(_this10.data);
          });
          this.replyContent = "";
          this.ScrollToBottom(); ////////////////////////////////////////////////////////////////////////////////////
        }
                  ...
                  case 0:
                    ...
                    return this.actionSheetController.create({
                      ...
                      buttons: [{
                        ...
                        text: 'Use Camera',
                        handler: function handler() {
                          _this11.takePicture(_this11.camera.PictureSourceType.CAMERA);
                        }
                      }, {
                        text: 'Cancel',
                        role: 'cancel'
        ...
        value: function takePicture(sourceType) {
          ...
          this.camera.getPicture(options).then(function (imagePath) {
            if (_this12.network.NetworkStateGetter()) {
              if (_this12.plt.is('android') && sourceType === _this12.camera.PictureSourceType.PHOTOLIBRARY) {
                _this12.filePath.resolveNativePath(imagePath).then(function (filePath) {
                  ...
                  _this12.startUpload(_this12.img.path);

                  _this12.image = {
                    sender_id: _this12.dId,
                    receiver_id: _this12.userToRecieve.patientId,
                    msg_body: "",
                    fcm_token: _this12.userToRecieve.fcmtoken,
                    media: _this12.pathForImage(_this12.img.path)
                  };

                  _this12.newMessages.push(_this12.image);

                  _this12.loading = true;

                  _this12.ref.detectChanges();

                  _this12.ScrollToBottom(); // this.copyFileToLocalDir(correctPath, currentName, this.createFileName());
        ...
        value: function copyFileToLocalDir(namePath, currentName, newFileName) {
          ...
          this.file.copyFile(namePath, currentName, this.file.dataDirectory, newFileName).then(function (success) {
            _this13.updateStoredImages(newFileName);
          }, function (error) {
            _this13.presentToast('Error while storing file.');
          });
        }
      }, {
        ...
        value: function updateStoredImages(name) {
          ...
          this.storage.get(STORAGE_KEY).then(function (images) {
            ...
            if (!arr) {
              ...
              _this14.storage.set(STORAGE_KEY, JSON.stringify(newImages));
            } else {
              arr.push(name);

              _this14.storage.set(STORAGE_KEY, JSON.stringify(arr));
            }

            var filePath = _this14.file.dataDirectory + name;

            var resPath = _this14.pathForImage(filePath);
            ...
            _this14.images = [newEntry].concat(_toConsumableArray(_this14.images));
            _this14.newMessages.find(function (msg) {
              return msg.media == _this14.pathForImage(_this14.img.path);
            }).media = resPath;
            _this14.loading = false;

            _this14.ref.detectChanges();
          });
        }
      }, {
        key: "startUpload",
        value: function startUpload(imgEntry) {
          ...
          this.file.resolveLocalFilesystemUrl(imgEntry).then(function (entry) {
            entry.file(function (file) {
              return _this15.readFile(file);
            });
          })["catch"](function (err) {
            _this15.presentToast('Error while reading file.');
          });
        }
      }, {
        key: "json",
        ...
        value: function readFile(file) {
          ...
          reader.onloadend = function () {
            ...
            formData.append('data', JSON.stringify(_this16.json()));

            _this16.httpService.UplaodingMediaMsg(formData, _this16.thread_id).subscribe(function (data) {
              console.log(" allData ", data);
              that.url = data.url;
              _this16.showSplash = false;
              console.log("Data Came: ", that.url);
              that.setMessege();

              _this16.ScrollToBottom();

              _this16.copyFileToLocalDir(_this16.img.correctPath, _this16.img.currentName, _this16.createFileName());
            }, function (err) {
              console.log("ERROR Occured will sending your msg");
            }, function () {
              console.log("Completed");
              console.log("Data Came3: ", that.newMessages);
              console.log("Data Came:2 ", _this16.image);
            });
        ...
        value: function doRefresh(event) {
          ...
          this.httpService.getReplies(this.thread_id, this.scrollingPosition).subscribe(function (res) {
            ...
            if (msgs.length) {
              _this17.newMessages = msgs.concat(_this17.newMessages);
              console.log("all msgs", _this17.newMessages);
              event.target.complete();

              _this17.ref.detectChanges();
    ...
    var ConvListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ConvListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          new Promise(function (resolve, reject) {
            _this18.docId = _this18.DoctortData.getDoctorId();
            console.log('check patient id'); // tslint:disable-next-line:triple-equals

            if (_this18.docId == undefined) {
              reject('doctor id is undefined ');
            } else {
              console.log('doctor id resolved');
              console.log('doctor_id', _this18.docId);
              resolve();
            }
          }).then(function () {
            console.log('doctor id form convlist', _this18.docId);

            _this18.GetData(0);

            _this18.state = 0; // at the fist time we need to assign the part of code we need to invoke every time the event emitter emits value
            // tslint:disable-next-line:triple-equals

            if (_this18.eventEmitterService.Subscribtion == undefined) {
              ...
              _this18.eventEmitterService.Subscribtion = _this18.eventEmitterService.FunctionCaller.subscribe(function (state) {
                _this18.state = state;

                _this18.GetData(state);

                console.log('event emitter listener invoked');
              });
            }
          })["catch"](function (err) {
            return _this18.presentAlert('data stream error', err.message);
          })["finally"](function () {
            _this18.detectChange.detectChanges();
        ...
        value: function GetData(state) {
          ...
          if (state == 0) {
            ...
            this.httpService.getInbox(this.docId, this.page).subscribe(function (res) {
              ...
              _this19.detectChange.detectChanges();
            }, function (error1) {
            ...
            this.httpService.getSent(this.docId, this.page).subscribe(function (res) {
              ...
              return _this19.presentAlert('http error get sent', error1);
            });
          }
        }
      }, {
        ...
        value: function doRefresh(event) {
          ...
          new Promise(function (resolve, reject) {
            console.log("state", _this20.state);

            _this20.GetData(_this20.state);
            ...
            _this20.detectChange.detectChanges();
          });
        } ///////////////////////////////////////////////////////////
        ...
        value: function loadData(event) {
          ...
          if (this.state == 0) {
            ...
            this.httpService.getSent(this.docId, this.page).subscribe(function (res) {
              ...
              event.target.complete();
              console.log('New list sent', _this21.convList);
              return;
            });
          }
        } //////////////////////////////////////////////////////////////////
                ...
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    return this.httpService.getReplies(thread.thread_id, 0).subscribe(function (res) {
                      ...
                      _this22.dateInteraction.sendMSG(newThread);

                      console.log('replies', res);

                      _this22.navigation.navigateTo('home/chat');
                    });
                    ...
                    try {
                      _loop = function _loop() {
                        ...
                        actionSheetButtons.push({
                          ...
                          icon: 'person',
                          handler: function handler() {
                            _this23.receiver = row.name;
                            console.log("Patient: " + _this23.receiver);

                            _this23.dataInteraction.sendPatientNamefromconvtoMessage(row);

                            console.log("row" + row);

                            _this23.navigation.navigateTo("home/message");
                          }
                        });
                      };
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      providers: [_NavService_navigation_service__WEBPACK_IMPORTED_MODULE_7__["NavigationService"], _HttPService_http_service__WEBPACK_IMPORTED_MODULE_8__["HttpService"], _services_Network_network_service__WEBPACK_IMPORTED_MODULE_21__["NetworkService"]],
                    ...
                    alert = this.addController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler(data) {
                          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this24, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
                            var _this25 = this;
                                ...
                                switch (_context10.prev = _context10.next) {
                                  case 0:
                                    ...
                                    this.http.addPatient(mobile).subscribe(function (response) {
                                      ...
                                      _this25.presentAlert('HTTP Error: ', errorMessage); // this.presentAlert('HTTP Add Patient Error: ', err.error.message);

                                    }, function () {
                                      console.log('HTTP to ADD Patient request completed.');

                                      _this25.navigation.navigateTo('home/doctorList');
                                    });
                    ...
                    return this.docList.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this26.navigation.navigateTo("home/message");
                        }
                      }, {
                        text: 'Voice Call',
                        icon: 'call',
      ...
      _createClass(MessageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.interactiveCommunication.data.subscribe(function (docData) {
            ...
            console.log(_this27.patientRow);
            that.setDocList();
                ...
                switch (_context14.prev = _context14.next) {
                  ...
                  case 4:
                    ...
                    return this.httpService.postThread(this.thread, this.doctorId).subscribe(function (res) {
                      ...
                      _this28.thread_id = res.insertId;
                      console.log("thread id created", _this28.thread_id);
                      var newThread = {
                        newMessages: _this28.newMessages.reverse(),
                        thread: _this28.thread,
                        thread_id: _this28.thread_id
                      };
                      console.log("thread for chatting", newThread);

                      _this28.interactiveCommunication.sendMSG(newThread);

                      _this28.navigation.navigateTo('home/chat'); // this.httpService.postReply(this.data,res.insertId).subscribe((msg)=>{
  ...
  function srcAppHomePatientProfilePatientProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PatientProfileComponent = /*#__PURE__*/function () {
      function PatientProfileComponent(dataShare, addController, navigation) {
      ...
      _createClass(PatientProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          new Promise(function (resolve, reject) {
            _this29.patientData = _this29.dataShare.getPatientData();

            if (_this29.patientData == undefined) {
            ...
            _this29.spinnerState = false;
            console.log("patient data from profile", _this29.patientData);
          })["catch"](function (err) {
            return _this29.presentAlert('data stream error', err);
          });
        }
      }, {
        key: "consultDoc",
                  ...
                  case 0:
                    ...
                    return this.addController.create({
                      ...
                      buttons: [{
                        text: 'Ok',
                        handler: function handler() {
                          _this30.spinnerState = false;

                          _this30.navigation.navigateTo('home/doctorList');
                        }
                      }]
                    });
  ...
  function srcAppHomePatientListPatientListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PatientListComponent = /*#__PURE__*/function () {
      function PatientListComponent(datastream, navigation, addController, http) {
      ...
      _createClass(PatientListComponent, [{
        ...
        value: function ionViewWillEnter() {
          ...
          this.http.getPatientList().subscribe(function (patient) {
            _this31.datastream.patientList.push(patient);
          }, function (err) {
            var errorMessage = "";
            ...
            _this31.patientRow = _this31.datastream.getPatientList();
            _this31.patientArrayList = _this31.patientRow;

            _this31.datastream.savePatientListToDataStore();
      ...
      _createClass(ProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          new Promise(function (resolve, reject) {
            ...
            if (_this32.InputData == undefined) {
              reject("undefined User Data");
            } else {
              resolve();
            }
          }).then(function () {
            _this32.spinnerState = false;
            console.log("resolved", _this32.InputData);
          })["catch"](function (err) {
                  ...
                  case 0:
                    alert = this.savedata.create({
                      ...
                      buttons: [{
                        text: 'Cancel',
                        handler: function handler(data) {
                          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this33, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
                        ...
                        handler: function handler(async) {
                          _this33.save_state = true;

                          var token = _this33.datastream.getToken();

                          console.log("data to save  ", _this33.InputData);

                          _this33.editPatientService.editDoctorProfile(_this33.InputData[0].value, _this33.InputData[3].value).subscribe(function (response) {
                            // this.datastream.setToken(response.token);
                            console.log("http request to Change patient Data: " + JSON.stringify(response));

                            _this33.datastream.changeDoctorData(_this33.InputData[0].value, _this33.InputData[3].value);
                          }, function (err) {
            ...
            if (images) {
              ...
              try {
                for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                  ...
                  var filePath = _this34.file.dataDirectory + img; // get path for image on our app directory

                  var resPath = _this34.pathForImage(filePath);
                  ...
                  case 0:
                    ...
                    return this.actionSheetController.create({
                      ...
                      buttons: [{
                        text: 'Load from Library',
                        handler: function handler() {
                          _this35.takePicture(_this35.camera.PictureSourceType.PHOTOLIBRARY);
                        }
                      }, {
                        text: 'Use Camera',
                        handler: function handler() {
                          _this35.takePicture(_this35.camera.PictureSourceType.CAMERA);
                        }
                      }, {
                        text: 'Cancel',
                        role: 'cancel'
        ...
        value: function takePicture(sourceType) {
          ...
          this.camera.getPicture(options).then(function (imagePath) {
            if (_this36.network.NetworkStateGetter()) {
              if (_this36.plt.is('android') && sourceType === _this36.camera.PictureSourceType.PHOTOLIBRARY) {
                _this36.filePath.resolveNativePath(imagePath).then(function (filePath) {
                  var correctPath = filePath.substr(0, filePath.lastIndexOf('/') + 1);
                  var currentName = imagePath.substring(imagePath.lastIndexOf('/') + 1, imagePath.lastIndexOf('?'));
                  _this36.profileImage = {
                    path: correctPath + currentName,
                    currentName: currentName,
                    correctPath: correctPath
                  };

                  _this36.startUpload(_this36.profileImage.path);
                });
              } else {
                var currentName = imagePath.substr(imagePath.lastIndexOf('/') + 1);
                var correctPath = imagePath.substr(0, imagePath.lastIndexOf('/') + 1);
        ...
        value: function copyFileToLocalDir(namePath, currentName, newFileName) {
          ...
          this.file.copyFile(namePath, currentName, this.file.dataDirectory, newFileName).then(function (success) {
            ...
            _this37.updateStoredImages(newFileName);
          }, function (error) {
        ...
        value: function updateStoredImages(name) {
          ...
          new Promise(function (resolve, reject) {
            _this38.storage.get(STORAGE_KEY).then(function (images) {
              var arr = JSON.parse(images);
              var newImage = [name];

              _this38.storage.set(STORAGE_KEY, JSON.stringify(newImage));

              var filePath = _this38.file.dataDirectory + name;

              var resPath = _this38.pathForImage(filePath); // Data Object to hold new image data
              ...
              _this38.ref.detectChanges(); // trigger change detection cycle


              _this38.datastream.changeDoctorProfileImage(_this38.image.path);

              if (_this38.image == undefined) {
        ...
        value: function readFile(file) {
          ...
          reader.onload = function () {
            ...
            _this40.uploadImageData(formData).then(function () {
                ...
                switch (_context19.prev = _context19.next) {
                  ...
                  case 6:
                    ...
                    this.http.postProfileImage(formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["finalize"])(function () {
                      ...
                      _this41.copyFileToLocalDir(_this41.profileImage.correctPath, _this41.profileImage.currentName, _this41.createFileName());
                    }, function (error1) {
      ...
      _createClass(NetworkService, [{
        ...
        value: function NetworkSubscription() {
          ...
          this.disconnectSubscription = this.network.onDisconnect().subscribe(function () {
            ...
            _this42.NetworkStateSetter(false);
          }); // watch network for a connection

          this.connectSubscription = this.network.onConnect().subscribe(function () {
            console.log('network connected!');

            _this42.NetworkStateSetter(true); // We just got a connection but we need to wait briefly
            // before we determine the connection type. Might need to wait.
            // prior to doing any api requests as well.


            setTimeout(function () {
              if (_this42.network.type === 'wifi') {
