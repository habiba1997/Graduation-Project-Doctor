...
const routes = [
    ...
    { path: 'cover', loadChildren: () => __webpack_require__.e(/*! import() | login-signup-login-signup-module */ "login-signup-login-signup-module").then(__webpack_require__.bind(null, /*! ./login-signup/login-signup.module */ "./src/app/login-signup/login-signup.module.ts")).then(c => c.LoginSignupModule) }
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".grad {\n  --background: linear-gradient(\n    to bottom,\n    #0a5279 0%,\n    #80d3cb 100%)\n    \n; }\n\n.opp {\n  opacity: 0.6; }\n\n.menu-bar {\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n  height: -webkit-fit-content;\n  height: -moz-fit-content;\n  height: fit-content;\n  --background: transparent;\n  color: white; }\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _services_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/datastorage/datastorage.service */ "./src/app/services/datastorage/datastorage.service.ts");
/* harmony import */ var _home_NavService_navigation_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./home/NavService/navigation.service */ "./src/app/home/NavService/navigation.service.ts");
/* harmony import */ var _services_datastream_datastreaming_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/datastream/datastreaming.service */ "./src/app/services/datastream/datastreaming.service.ts");
...
/* harmony import */ var _home_HttPService_http_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./home/HttPService/http.service */ "./src/app/home/HttPService/http.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, datastore, nav, datastream, fcm, http, menu_controller, toastController) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            let that = this;
            this.datastore.isTokenExpired().then((isTokenExpired) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                console.log("isTokenExpired: " + isTokenExpired);
                if (!isTokenExpired) {
                    console.log(" app compoennt :: Token isnot expired:  " + isTokenExpired);
                    yield this.datastore.getDoctorData().then((doctor) => {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_10__["timer"])(3000).subscribe(() => this.showSplash = false);
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _services_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_5__["DatastorageService"],
        _home_NavService_navigation_service__WEBPACK_IMPORTED_MODULE_6__["NavigationService"],
        _services_datastream_datastreaming_service__WEBPACK_IMPORTED_MODULE_7__["DatastreamingService"],
        _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_8__["FCM"],
        _home_HttPService_http_service__WEBPACK_IMPORTED_MODULE_9__["HttpService"],
...
/* harmony import */ var _home_HttPService_http_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./home/HttPService/http.service */ "./src/app/home/HttPService/http.service.ts");
/* harmony import */ var _services_datastream_datastreaming_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/datastream/datastreaming.service */ "./src/app/services/datastream/datastreaming.service.ts");
/* harmony import */ var _services_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/datastorage/datastorage.service */ "./src/app/services/datastorage/datastorage.service.ts");
...
/* harmony import */ var node_modules_ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! node_modules/@ionic-native/camera/ngx */ "./node_modules/@ionic-native/camera/ngx/index.js");
/* harmony import */ var node_modules_ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! node_modules/@ionic-native/file/ngx */ "./node_modules/@ionic-native/file/ngx/index.js");
/* harmony import */ var node_modules_ionic_native_ionic_webview_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! node_modules/@ionic-native/ionic-webview/ngx */ "./node_modules/@ionic-native/ionic-webview/ngx/index.js");
/* harmony import */ var node_modules_ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! node_modules/@ionic-native/file-path/ngx */ "./node_modules/@ionic-native/file-path/ngx/index.js");
/* harmony import */ var _ionic_native_media_capture_ngx__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ionic-native/media-capture/ngx */ "./node_modules/@ionic-native/media-capture/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(),
            ...
            _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_13__["FormsModule"]],
        providers: [
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
            _home_HttPService_http_service__WEBPACK_IMPORTED_MODULE_9__["HttpService"],
            _services_datastream_datastreaming_service__WEBPACK_IMPORTED_MODULE_10__["DatastreamingService"],
            _services_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_11__["DatastorageService"],
            _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_14__["FCM"],
            _home_HttPService_http_service__WEBPACK_IMPORTED_MODULE_9__["HttpService"],
            node_modules_ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_17__["Camera"],
            node_modules_ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_18__["File"],
            node_modules_ionic_native_ionic_webview_ngx__WEBPACK_IMPORTED_MODULE_19__["WebView"],
            node_modules_ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_20__["FilePath"],
            _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_16__["Network"],
            _ionic_native_media_capture_ngx__WEBPACK_IMPORTED_MODULE_21__["MediaCapture"],
...
/* harmony import */ var src_app_model_token__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/model/token */ "./src/app/model/token.ts");
/* harmony import */ var src_app_model_patientData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/model/patientData */ "./src/app/model/patientData.ts");
/* harmony import */ var _model_ConsultationModel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../model/ConsultationModel */ "./src/app/model/ConsultationModel.ts");
/* harmony import */ var src_app_model_doctor_doctor_appointment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/model/doctor/doctor_appointment */ "./src/app/model/doctor/doctor_appointment.ts");
/* harmony import */ var src_app_model_doctor_id_date__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/model/doctor/id_date */ "./src/app/model/doctor/id_date.ts");
/* harmony import */ var src_app_services_dateFormatService_date_format_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/dateFormatService/date-format.service */ "./src/app/services/dateFormatService/date-format.service.ts");
...
let HttpService = class HttpService {
    constructor(http, dataStream, format, fcm) {
        this.http = http;
        this.dataStream = dataStream;
        this.format = format;
        this.fcm = fcm;
    ...
    Login(email, pass) {
        ...
        return this.http.post(url, {
            "username": email,
            "password": pass
        }, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((token) => {
    ...
    getPatientList() {
        ...
        return this.http.get(url, this.gethttpOption()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(doctors => doctors), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((patient) => {
    ...
    editFCMToken() {
        ...
        this.fcm.getToken().then((fcmtoken) => {
            this.http.post(url, {
                "fcmtoken": fcmtoken
            }, this.gethttpOption()).subscribe((error) => {
    ...
    getInbox(user_id, offset) {
        ...
        console.log("URL", Url);
        return this.http.get(Url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])((consult) => { console.log("consult", consult); return consult; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((consult) => {
            console.log("map", consult);
            console.log("patients", this.dataStream.getPatientList());
            return new _model_ConsultationModel__WEBPACK_IMPORTED_MODULE_8__["inboxThread"](consult.sender_id, consult.receiver_id, consult.thread_id, consult.msg_subject, consult.created_date, consult.is_readed, consult.sender_name, consult.receiver_name, consult.msg_body, this.dataStream.getPatientList().find(patientData => patientData.patientId == consult.sender_id).user_img);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((consults, consult) => {
            if (consults.length) {
    ...
    postDoctorAppointmnets(appointments) {
        ...
        // let scheduleIds =[];
        return this.http.post(url, appointments).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(appointments => appointments), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((appointmentObject) => {
    ...
    getDoctorSchedule() {
        ...
        return this.http.get(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(appointments => appointments), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((appointment) => {
    ...
    getDoctorAppointmentSLots(id, date, slot_duration) {
        let url = "http://ec2-3-87-1-35.compute-1.amazonaws.com:3000/api/users/doctor/slots/" + id;
        let bool = false;
        return this.http.get(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(slots => slots), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((slot) => {
            ...
            if (slot.patient_id) {
                ...
                return new src_app_model_doctor_doctor_appointment__WEBPACK_IMPORTED_MODULE_9__["doctor_appointment"](slot.id, this.dataStream.doctor.doctor_id, slot.schedule_id, slot_duration, slot.start_time, slot.end_time, date, slot.patient_id, this.dataStream.patientList[patientIndex], slot.booked.data[0] == 0 ? false : true);
            }
            else {
                return new src_app_model_doctor_doctor_appointment__WEBPACK_IMPORTED_MODULE_9__["doctor_appointment"](slot.id, this.dataStream.doctor.doctor_id, slot.schedule_id, slot_duration, slot.start_time, slot.end_time, date, null, null, slot.booked.data[0] == 0 ? false : true);
            }
        }));
    }
};
...
HttpService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        ...
        src_app_services_dateFormatService_date_format_service__WEBPACK_IMPORTED_MODULE_11__["DateFormatService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "inboxThread", function() { return inboxThread; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class inboxThread {
    constructor(sender_id, receiver_id, thread_id, msg_subject, created_date, is_readed, sender_name, receiver_name, msg_body, profile_img) {
...
/***/ "./src/app/model/MyData.ts":
/*!*********************************!*\
  !*** ./src/app/model/MyData.ts ***!
  \*********************************/
/*! exports provided: MyDoctor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyDoctor", function() { return MyDoctor; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "doctor_appointment", function() { return doctor_appointment; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class doctor_appointment {
    constructor(id, doc_id, schedule_id, slot_duration, start_time, end_time, date, patient_id, patient, booked) {
        this.id = id;
        this.doc_id = doc_id;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostReturnIdAndDate", function() { return PostReturnIdAndDate; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

class PostReturnIdAndDate {
    constructor(id, date) {
        this.id = id;
        this.date = date;
    }
...
class patientData {
    constructor(patientId, name, fcmtoken, mobile, age, address, relationid, user_img) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TokenClass", function() { return TokenClass; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/***/ "./src/app/services/datastorage/datastorage.service.ts":
/*!*************************************************************!*\
  !*** ./src/app/services/datastorage/datastorage.service.ts ***!
  \*************************************************************/
...
let DatastorageService = class DatastorageService {
    ...
    isTokenExpired() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let that = this;
            yield this.getDoctorToken().then(token => {
                if (token != null) {
...
/*!**************************************************************!*\
  !*** ./src/app/services/datastream/datastreaming.service.ts ***!
  \**************************************************************/
/*! exports provided: DatastreamingService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DatastreamingService", function() { return DatastreamingService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../datastorage/datastorage.service */ "./src/app/services/datastorage/datastorage.service.ts");
/* harmony import */ var src_app_model_MyData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/model/MyData */ "./src/app/model/MyData.ts");
/* harmony import */ var src_app_model_patientData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/model/patientData */ "./src/app/model/patientData.ts");
...
let DatastreamingService = class DatastreamingService {
    ...
    restoreStreamDatalist(patientList) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            (yield patientList).forEach(element => {
    ...
    changeDoctorProfileImage(imgPath) {
...
DatastreamingService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_datastorage_datastorage_service__WEBPACK_IMPORTED_MODULE_2__["DatastorageService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DateFormatService", function() { return DateFormatService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let DateFormatService = class DateFormatService {
    ...
    formateDateToJSON(myDate) {
        let date = moment__WEBPACK_IMPORTED_MODULE_2__(myDate).format();
    ...
    compareDate(date1, date2) {
        ...
        let d1 = moment__WEBPACK_IMPORTED_MODULE_2__(date1).format();
        ;
        let d2 = moment__WEBPACK_IMPORTED_MODULE_2__(date2).format();
        ;
        // console.log(d1);
        // console.log(d2);
        // console.log(" ");
...
DateFormatService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    }),
...
module.exports = __webpack_require__(/*! /home/habiba/GP/new/Graduation-Project-Doctor/src/main.ts */"./src/main.ts");
